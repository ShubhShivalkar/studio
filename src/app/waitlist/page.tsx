...
const Header = ({ onJoinClick }: { onJoinClick: () => void }) => (
  <header className="fixed top-0 left-0 right-0 bg-background/80 backdrop-blur-sm z-10 border-b">
    <div className="container mx-auto px-4 py-4 flex justify-between items-center">
      <div>
        <h1 className="text-xl font-bold">anuvaad's inner circle</h1>
        <p className="text-sm text-muted-foreground">Join the waitlist to get early access.</p>
      </div>
...
const WaitlistForm = ({
  ...
  setCommunicationInterest,
  handleSubmit,
}: any) => (
  <section id="join-waitlist-form" className="pt-24">
    <div className="grid md:grid-cols-2 gap-12 items-start">
        <div className="flex flex-col justify-center h-full text-center md:text-left">
            <h2 className="text-3xl font-bold mb-4">Tired of Swiping? Find Your Tribe.</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
                In a world of endless scrolling and superficial connections, finding a genuine community can feel impossible. We get it. That's why we're building <strong>anuvaad</strong>—a place to connect with like-minded individuals on a deeper level.
                <br/><br/>
                Through AI-powered insights from your own reflections, we help you discover a small, compatible "Tribe" where you can be yourself, share your journey, and build lasting friendships.
                <br/><br/>
                Ready for something more meaningful? Join our inner circle.
            </p>
        </div>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea id="suggestions" value={suggestions} onChange={(e: any) => setSuggestions(e.target.value)} />
                            </div>
...
const FinalCTA = ({ onJoinClick }: { onJoinClick: () => void }) => (
    <section>
        <div className="text-center">
    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12" ref={formRef}>
        <WaitlistForm
            ...
            signupInterest={signupInterest}
            setSignupInterest={setSignupInterest}
            communicationInterest={communicationInterest}
            setCommunicationInterest={setCommunicationInterest}
